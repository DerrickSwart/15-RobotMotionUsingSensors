...
def run_test_go_straight_for_seconds():
    ...
    # -------------------------------------------------------------------------
    robot = SimpleRoseBot()
    robot.go_straight_for_seconds(4, 50)
    robot.go_straight_for_seconds(2, 100)
...
def run_test_go_straight_until_black():
    ...
    # -------------------------------------------------------------------------
    robot = SimpleRoseBot()
    robot.go_straight_until_black(20)
...
class SimpleRoseBot(object):
    ...
    def go_straight_until_black(self, speed):
        self.go(speed, speed)
        while True:
            color = self.color_sensor.get_reflected_light_intensity()
            if color < 10:
                break
        self.stop()
